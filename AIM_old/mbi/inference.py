import os 
import numpy as np
import AIM_old.mbi.callbacks as callbacks
from AIM_old.mbi.Domain import *
from AIM_old.mbi.graphical_model import *
from AIM_old.mbi.clique_vector import *
...
class FactoredInference:
    def __init__(
        ...
        if backend == "torch":
            from AIM_old.mbi.torch_factor import Factor
