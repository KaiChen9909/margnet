...
def algo_ablation_method(args):
    if args.method == 'aim':
        ...
        from method.MargDL.main import marggan_ablation_main
        ...
        from method.MargDL.main import marggan_ablation_all
        algo = marggan_ablation_all
    elif args.method == 'marggan_marg':
        from method.MargDL.main import marggan_ablation_marg
